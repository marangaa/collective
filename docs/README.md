...
| [03 — Data model](03-data-model.md) | Postgres schema v2, lifecycle rules, OCDS/FtM alignment, geospatial |
...
- **AI usage (build + product)** → `04-ai-pipeline.md` + commit history + `AI-USAGE.md` (to be kept at repo root)
